...
### Versions supportées
- Home Assistant Core **2024.1.0** ou plus récent
...
Par défaut, l'intégration interroge OPNsense toutes les **60 secondes**. Pour modifier :

**Paramètres → Appareils et services → OPNsense → ⚙ Configurer** → valeur entre 30 et 600 secondes.
